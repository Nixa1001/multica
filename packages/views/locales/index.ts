...
import enYoutubeStudio from "./en/youtube-studio.json";
...
import zhHansYoutubeStudio from "./zh-Hans/youtube-studio.json";
...
import koYoutubeStudio from "./ko/youtube-studio.json";
...
import jaYoutubeStudio from "./ja/youtube-studio.json";
...
export const RESOURCES: Record<SupportedLocale, LocaleResources> = {
  en: {
    ...
    squads: enSquads,
    billing: enBilling,
    "youtube-studio": enYoutubeStudio,
  },
  "zh-Hans": {
    common: zhHansCommon,
    auth: zhHansAuth,
    ...
    "youtube-studio": zhHansYoutubeStudio,
  },
  ko: {
    common: koCommon,
    auth: koAuth,
    ...
    squads: koSquads,
    billing: koBilling,
    "youtube-studio": koYoutubeStudio,
  },
  ja: {
    common: jaCommon,
    auth: jaAuth,
    ...
    squads: jaSquads,
    billing: jaBilling,
    "youtube-studio": jaYoutubeStudio,
  },
};
